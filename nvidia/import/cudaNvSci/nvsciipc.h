 ...
 * - ::NvSciError_InvalidState       Indicates an invalid operation state.
 *
 * @pre NvSciIpcResetEndpointSafe() must be called.
 *
 * @usage
 * - Allowed context for the API call
 *   - Interrupt: No
 ...
 *
 * Prior to calling this function, both @c ChannelCreate_r() and
 * @c ConnectAttach_r() must be called in the application to obtain the value
 * for @a coid to pass to this function.
 *
 ...
 *
 * Applications can define any value per endpoint for @a pulseCode and
 * @a pulseValue. @a pulseCode will be used by NvSciIpc to signal IPC events and
 * should be reserved for this purpose by the application. @a pulseValue can be
 * used for the application cookie data.
 *
